#!/bin/bash
# Full subjects 1-5 screen for one electrode-preserving candidate family.
set -euo pipefail
...
OUTPUT_DIR="$PWD/results/things_eeg/ensemble_arch_candidates/electrode_preserving/$ARM/seed3300"
...
# Stage-2 artifact: score matrices for the fixed ATM+TSConv complementarity test.
