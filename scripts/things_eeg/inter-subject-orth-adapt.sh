...
SELECT_BEST_METRIC="${SELECT_BEST_METRIC:-top1}"

SUBJECT_ADAPT_LAMBDA="${SUBJECT_ADAPT_LAMBDA:-0.2}"
SUBJECT_ADAPT_SPLIT_A_RATIO="${SUBJECT_ADAPT_SPLIT_A_RATIO:-0.5}"
SUBJECT_ADAPT_MIN_SAMPLES="${SUBJECT_ADAPT_MIN_SAMPLES:-8}"
SUBJECT_ADAPT_INTERVAL="${SUBJECT_ADAPT_INTERVAL:-4}"
SUBJECT_ADAPT_SAW_SHRINK="${SUBJECT_ADAPT_SAW_SHRINK:-0.85}"
SUBJECT_ADAPT_CSLS_K="${SUBJECT_ADAPT_CSLS_K:-5}"
SUBJECT_ADAPT_SINKHORN_TAU="${SUBJECT_ADAPT_SINKHORN_TAU:-0.1}"
SUBJECT_ADAPT_SINKHORN_ITERS="${SUBJECT_ADAPT_SINKHORN_ITERS:-15}"
SUBJECT_ADAPT_SOFT_STEPS="${SUBJECT_ADAPT_SOFT_STEPS:-8}"
...
echo "select_best_metric=${SELECT_BEST_METRIC}"
echo "subject_adapt=lambda${SUBJECT_ADAPT_LAMBDA}_split${SUBJECT_ADAPT_SPLIT_A_RATIO}_interval${SUBJECT_ADAPT_INTERVAL}_saw${SUBJECT_ADAPT_SAW_SHRINK}_k${SUBJECT_ADAPT_CSLS_K}_tau${SUBJECT_ADAPT_SINKHORN_TAU}_steps${SUBJECT_ADAPT_SOFT_STEPS}_pow${SUBJECT_ADAPT_SOFT_POWER}_iters${SUBJECT_ADAPT_SINKHORN_ITERS}_norenorm${SUBJECT_ADAPT_NO_RENORM}"
echo "=========================================================="
...
do
    ...
    ARGS=(
        ...
        --subject_adapt_interval "$SUBJECT_ADAPT_INTERVAL"
