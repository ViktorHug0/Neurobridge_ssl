...
SOURCE_RUN_ROOT="${SOURCE_RUN_ROOT:-${REPO_ROOT}/results/things_eeg/inter-subjects/tsconv_dropout_sweep_20260429-190741}" # "tsconv_dropout_sweep_20260428-142358}"
# By default, use only the first seed from the dropout sweep.
# Override with space-separated globs, e.g. SOURCE_CONFIG_PATTERNS="param_*"
...
SOFT_STEP_VALUES="${SOFT_STEP_VALUES:-16}"
SOFT_POWER_VALUES="${SOFT_POWER_VALUES:-1.2}"
SINKHORN_ITER_VALUES="${SINKHORN_ITER_VALUES:-12}"
TAU_VALUES="${TAU_VALUES:-0.1}"
K_VALUES="${K_VALUES:-3}"
SAW_SHRINK_VALUES="${SAW_SHRINK_VALUES:-0.94}"
