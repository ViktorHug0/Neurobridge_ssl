...
# Feature sets: dinov2 + vit_b
IMAGE_FEATURE_SETS=(
    "/nasbrain/p20fores/Neurobridge_SSL/data/things_eeg/image_feature/dinov2-giant_layer16_mean"
    "/nasbrain/p20fores/Neurobridge_SSL/data/things_eeg/image_feature/ViT-B-16_layer06__mean"
)

SEEDS=(3300)

SESSION_TIMESTAMP=${1:-"20260429-221100"}
SESSION_DIR="${OUTPUT_DIR_BASE}/eeg_encoder_architecture_sweep_nomixup_${SESSION_TIMESTAMP}"
...
do
    ...
    echo "=========================================================="
    echo "STARTING SWEEP FOR IMAGE FEATURES: $FEAT_NAME (NO MIXUP)"
    echo "=========================================================="
    ...
    do
        ...
        do
            CONFIG_NAME="${FEAT_NAME}_${ARCH}_seed${SEED}_nomixup"
...
echo "dinov2/vit_b nomixup sweep completed: ${SESSION_SUMMARY}"
