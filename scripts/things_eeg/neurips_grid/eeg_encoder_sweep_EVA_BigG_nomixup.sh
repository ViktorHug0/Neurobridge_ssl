...
# Feature sets: EVA + BigG
IMAGE_FEATURE_SETS=(
    "/nasbrain/p20fores/Neurobridge_SSL/data/things_eeg/image_feature/EVA02-E-14_layer35_mean"
    "/nasbrain/p20fores/Neurobridge_SSL/data/things_eeg/image_feature/ViT-bigG-14_layer27_mean"
)
...
echo "EVA/BigG nomixup sweep completed: ${SESSION_SUMMARY}"
