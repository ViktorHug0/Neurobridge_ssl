...
#
# Examples:
#   ./scripts/alljoined/tta_sattc_oat_sweep.sh
#   SWEEP_DIM=tau ./scripts/alljoined/tta_sattc_oat_sweep.sh
#   TAU_VALUES="0.06 0.08 0.1" SWEEP_DIM=tau ./scripts/alljoined/tta_sattc_oat_sweep.sh
set -e
...
BASE_K="${BASE_K:-3}"
BASE_SAW="${BASE_SAW:-0.96}"
BASE_TAU="${BASE_TAU:-0.1}"
BASE_SOFT_STEPS="${BASE_SOFT_STEPS:-16}"
BASE_SOFT_POWER="${BASE_SOFT_POWER:-1.6 1.7 1.8}"
