...
SOURCE_RUN_ROOT="${SOURCE_RUN_ROOT:-${REPO_ROOT}/results/things_meg/inter-subjects/things_meg_mixup_20260505-225744}" # "tsconv_dropout_sweep_20260428-142358}"
...
do
    ...
    # Best Alljoined TTA config so far among full 20-subject runs.
    run_spec_for_source \
        "$SOURCE_RUN_DIR" \
        "$SOURCE_LABEL" \
        "saw0p98_k3_tau0p08_steps1_pow1p5_iters5" \
        "saw_csls" \
        "3" \
        "0.98" \
        "0.08" \
